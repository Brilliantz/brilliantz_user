...
const SuccessNotif = () => {
    ...
    return (
        <div 
            ...
            className="d-flex justify-content-between flex-column align-items-center text-center"    
        >   
            <div>
            ...
            <h1 style={{fontSize: '32px'}}>Profilmu sudah lengkap , yuk siap-siap daftar TryOut nya, semangat</h1>
            <Button style={{height: '48px' , width: '220px', backgroundColor: 'transparent' , border: '2px solid #4A47D6' , color: '#4A47D6'}} onClick={() => history.push('/dashboard')}>
