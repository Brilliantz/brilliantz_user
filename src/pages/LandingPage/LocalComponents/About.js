...
const About = ({ size }) => {
    return (
        <div id="about">
            <div className={`${size.width < 1200 ? "" : "d-flex "} align-items-center`} style={{ padding: `${size.width < 1200 ? "50px 0px" : "70px 0px"}` }}>
                <div className={`${size.width < 1200 ? "w-100" : "w-50"} ${size.width < 1200 ? "mb-4" : ""}`}>
                    <h1 className={`${size.width < 1200 ? "mb-4" : "my-4"} fw-bold`}>Tentang Brilliantz</h1>
                ...
                <div className={`w-100 h-100 d-flex justify-content-end ${size.width < 1200 ? "flex-column-reverse" : "align-items-end"} flex-wrap `}>
                    <div className={`${size.width < 1200 ? "my-3" : "mb-5"} mx-4 text-center`}>
                    ...
                    <img src={imageAbout} alt="imageJumbotron" style={{ width: `${size.width < 1200 ? "100%" : "508px"}`, height: `${size.width < 1200 ? "100%" : "auto"}`, borderRadius: '15px' }} />
                </div>
            </div>
        </div>
    )
